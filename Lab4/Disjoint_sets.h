...
void Disjoint_set::union_sets(int node_index1, int node_index2) {
    ...
    //update the pointer for si1 to be lager and si2 to be smaller
    si1 = nodes[ni1]->ptr_to_info;
    si2 = nodes[ni2]->ptr_to_info;
    
    ll_entry* smallNode = si2->head;
    
    //combine the larger linked list with the smaller one
